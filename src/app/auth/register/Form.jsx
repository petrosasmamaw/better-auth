...
export default function RegisterForm({ action }) {
  return (
    <form action={action} className="w-full max-w-md bg-white dark:bg-slate-800 p-8 rounded-lg shadow">
      <h1 className="text-2xl font-bold mb-4 text-slate-900 dark:text-slate-100">Register</h1>
      ...
      <button type="submit" className="w-full py-2 rounded bg-emerald-600 text-white">Create account</button>
    </form>
  );
}
